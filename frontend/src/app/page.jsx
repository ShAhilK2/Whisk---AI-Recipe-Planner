        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <h1 className="text-6xl md:text-8xl text-stone-900 mb-6 font-bold leading-[0.9] tracking-tight">
                Turn your
                <br />
              ...
              <Link href="/dashboard">
                ...
                >
                  Start Cooking Free <ArrowRight className="ml-2 -5 h-5" />
                </Button>
              </Link>
              <p className="mt-6 text-sm text-stone-600">
                <span className="font-bold text-tone-900">10k+ cooks</span>{" "}
                Joined last month
              </p>
            </div>
            ...
            <Card className="relative aspect-square md:aspect-4/5 border-4 border-stone-900 bg-stone-200 overflow-hidden py-0">
              <Image
                src="/section-img.avif"
                alt="Delicious food"
                width={500}
                height={500}
                className="w-full h-full object-cover"
              />
              <Card className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-sm border-2 border-stone-800 py-0">
                <CardContent className={"p-4"}>
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <h3>
                        Loaded nachos topped with cheese, corn, beans,
                        jalapeños, green onions, and a dollop of sour cream
                      </h3>
                  ...
                  <div className="flex gap-4 text-xs text-stone-500 font-medium ">
                    ...
                    <span className="flex items-center gap-1">
                      <Users className="w-3 h-3" /> 25 mins
                    </span>
                  </div>
                </CardContent>
              </Card>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <p className="text-stone-600 text-xl font-light">
              Everythingyou need to master our meal prep.
            </p>
          </div>
                ...
                >
                  <CardContent className={"p-8"}>
                    <div className="flex justify-between items-start mb-6">
                      <div className="border-2 border-stone-200 bg-orange-50 p-3 group:hover:order-orange-600 group:hover:bg-orange-100 transition-colors">
                        <IconComponent className="w-6 h-6" />
                      </div>
                      <Badge
                        variant="secondary"
                        className="text-xs font-mono text-stone-600 uppercase tracking-wide border border-stone-200 bg-orange-50"
                      >
                        {feature.limit}
                      </Badge>
                    </div>
